...
from wolf_strategy import SUPPORTED_WOLF_KILL_STRATEGIES


def run_wolf_strategy_experiment(
    strategies=None,
    ...
    if strategies is None:
        strategies = SUPPORTED_WOLF_KILL_STRATEGIES
    ...
    for strategy in strategies:
        results = run_simulation(
            ...
            wolf_kill_strategy=strategy,
            witch_poison_threshold=DEFAULT_WITCH_POISON_THRESHOLD,
        )
        summary = summarize_results(results)
        summary["wolf_kill_strategy"] = strategy
        experiment_results.append(summary)

    return experiment_results


def print_wolf_strategy_results(experiment_results):
    print("Wolf strategy experiment")
    print("------------------------")

    for summary in experiment_results:
        print(
            f"Strategy: {summary['wolf_kill_strategy']} | "
...
if __name__ == "__main__":
    results = run_wolf_strategy_experiment()
    print_wolf_strategy_results(results)
